...
function Scribble(p) {
	...
	this.getIntersectingLines = (lineCoords, xCoords, yCoords) => {
		var intersections = [];
		var s1 = new Segment(
			lineCoords[0],
			lineCoords[1],
...
function Segment(_x1, _y1, _x2, _y2) {
	...
	this.getIntersectionX = () => xi;

	this.getIntersectionY = () => yi;

	this.getLength = (tx1, ty1, tx2, ty2) => {
		var dx = tx2 - tx1;
		var dy = ty2 - ty1;
